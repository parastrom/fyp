...
from text2sql.dataproc import spider_dataset
import datasets
...
if __name__ == "__main__":
    ...
    db_dct = datasets.load_dataset(path="../dataproc/loaders/spider.py", cache_dir=DATASETS_PATH, split='validation')
    lst_output = []
    dbs = spider_dataset.process(db_dct)
    ...
    outfile_path = parent_dir + "/" + "validation_match_values.json"
