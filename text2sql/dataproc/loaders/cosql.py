...
# from torch.utils.data import dataproc
import datasets
from text2sql.settings import DATASETS_PATH
from text2sql.third_party.spider.get_tables import dump_db_json_schema
...
class CoSQL(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        datasets.BuilderConfig(
            name="cosql",
            version=VERSION,
            description="""A Conversational Text-to-SQL Challenge Towards 
    ...
    def _info(self) -> datasets.DatasetInfo:
        ...
        return datasets.DatasetInfo(
            description="CoSQL is a large-scale dataproc for training and testing task oriented dialog agents with SQL",
            features=features,
